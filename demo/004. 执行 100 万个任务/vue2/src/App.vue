...
export default {
  name: 'App',
  components: { DirectTask, SetTimeoutTask, IdleCallbackTask, WorkerTask },
  data() {
    return {
      method: 'worker',
      tabs: [
        ...
        {
          key: 'setTimeout',
          label: '方法二: setTimeout 分片',
          desc: '分批执行 + setTimeout 让出主线程',
        },
        {
          key: 'idleCallback',
          label: '方法三: requestIdleCallback',
          desc: '利用浏览器空闲时间执行',
        },
