...
<template>
  <div class="comp beta">
    <div class="comp-head">
      <span class="tag">组件名：BetaComp</span>
      <span class="color-label">Beta</span>
    </div>
    <p class="desc">
      本组件名为 <code>BetaComp</code>。尝试用 <code>include="AlphaComp,BetaComp"</code>
      或 <code>include=/^Beta/</code> 来缓存它，或用 <code>exclude="BetaComp"</code> 来排除它。
    </p>
